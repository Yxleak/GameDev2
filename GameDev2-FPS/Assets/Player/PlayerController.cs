...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // Projects speed in which player goes.
    ...
    private Vector3 MoveAir(Vector3 wish_dur, Vector3 current_velocity)
    {
        return Accelerate(wish_dir, current_velocity, acceleration, max_speed);
    }
    private Vector3 MoveGround(Vector3 wish_dur, Vector3 current_velocity)
    {
        Vector3 new_velocity = new Vector3(current_velocity.x, 0, current_velocity.z); //Remove y velocity component
        ...
        new_velocity = new Vector3(new_velocity.x, current_velocity.y, current_velocity.z); //Add back y velocity component
